...
namespace Data
{
    ...
    public partial class DataProductsEntities : DbContext
    {
        ...
        public virtual ObjectResult<byte[]> ACOB_SelectImages(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<byte[]>("ACOB_SelectImages", idParameter);
        }
